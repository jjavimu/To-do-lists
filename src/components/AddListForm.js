    ...
    return (props.trigger) ? (
        <div className="add-list">
            ...
            <form className="add-list-form" onSubmit={callAddList}>
                <input type="text" placeholder="Add a new list" value={nameInput} name="text" className="name-input" onChange={updateName} />
                <input type="text" placeholder="List description" value={descInput} name="desc" className="desc-input" onChange={updateDesc} />
                <br />
